...
#
# Notification:
# Email is handled by GitHub Actions.
# This Python script only creates hourly_signals.csv.
# ============================================================
...
def check_stock(symbol):
    ...
    try:
        ...
        return {
            ...
            "Previous 1H RSI(5)":
                round(float(previous_hour_rsi), 2)
        }
...
def main():
    ...
    if not results:
        ...
        # Always create CSV so that
        # GitHub Actions can attach it.
        empty_columns = [
            "Stock",
            "Monthly RSI(5)",
            "Monthly RSI SMA(14)",
